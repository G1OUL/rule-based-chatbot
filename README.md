...
#Features:-
1.Input/Sanitization: Normalizes user input using .lower() and .strip() to ensure consistent processing regardless of formatting.
2.Logic Skeleton: Utilizes a dictionary-based lookup for $O(1)$ efficiency, ensuring 100% predictable, "white-box" behavior.
3.Control Flow: Operates in a continuous while loop with a defined exit strategy to maintain system stability.
